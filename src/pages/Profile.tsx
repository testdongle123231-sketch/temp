  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="bg-gradient-to-br from-orange-400 to-pink-500 rounded-3xl p-8 mb-8 relative overflow-hidden">
        ...
        {!user.isPremium && (
          <motion.div
            ...
            className="bg-gradient-to-r from-yellow-400 via-orange-500 to-pink-500 rounded-2xl p-6 mb-8 cursor-pointer"
